      ...
      case 1:
        return (
          <div className="flex flex-col gap-y-2 items-center justify-center">
            <Success type="info" />
            <h2 className="text-lg font-bold text-primary-text">{`Are you sure you want to delete ${title}?`}</h2>
            <p className="text-sm text-center">
              This deal will be deleted permanently and cannot be recovered
            </p>
            <div className="flex mt-4 gap-x-3 w-full items-center">
              <Button variant={"secondary"} className="w-full h-[51px] py-3">
                Deactivate Instead
              </Button>
              <Button
      ...
      default:
        return (
          <div className="flex flex-col gap-y-2 items-center justify-center">
            ...
            <p className="text-sm text-center">
              Sunday Buffet Special Deal has been deleted permanently
            </p>
          </div>
        );
    }
