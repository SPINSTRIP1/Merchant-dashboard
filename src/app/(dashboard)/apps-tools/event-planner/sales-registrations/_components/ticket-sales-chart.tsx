      ...
      <div className="flex gap-x-3 items-center">
        <div className="relative h-[147px] w-[147px] ">
          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center pointer-events-none">
            <p className="text-lg font-bold text-primary-text">N4,371,098</p>
            <p className="text-xs text-secondary-text">Total Ticket sales</p>
          </div>
        </div>
      ...
      <div className="flex mt-5 gap-x-3 items-center">
        <div className="relative h-[147px] w-[147px] ">
          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center pointer-events-none">
            ...
            <p className="text-xs text-secondary-text">Total Tickets Sold</p>
          </div>
        </div>
